...
from proy_techcommit_custom_interface.srv import MyMovimientoRobot
...
class Service(Node):
    def __init__(self):
        ...
        self.srv = self.create_service(MyMovimientoRobot, 'movement', self.my_first_service_callback)
