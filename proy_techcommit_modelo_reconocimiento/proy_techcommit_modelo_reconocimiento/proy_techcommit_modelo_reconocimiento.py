...
class RobotGandiaDeepLearningNode(Node):
    ...
    def __init__(self):
        ...
        self.fomo_image_publisher = self.create_publisher(Image, '/fomo_image', 10)
    ...
    def listener_callback(self, data):
        ...
        #img = cv2.cvtColor(img, cv2.COLOR_UC)
...
def main(args=None):
    ...
    proy_techcommit_modelo_reconocimento = RobotGandiaDeepLearningNode()

    rclpy.spin(proy_techcommit_modelo_reconocimento)

    # Destroy the node explicitly
    # (optional - otherwise it will be done automatically
    # when the garbage collector destroys the node object)
    proy_techcommit_modelo_reconocimento.destroy_node()
    rclpy.shutdown()
